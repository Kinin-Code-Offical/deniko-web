...
-- CreateEnum
CREATE TYPE "HomeworkStatus" AS ENUM ('PENDING', 'COMPLETED', 'INCOMPLETE', 'MISSING', 'LATE');
...
-- CreateIndex
CREATE INDEX "StudentProfile_studentNo_idx" ON "StudentProfile"("studentNo");

-- CreateIndex
CREATE INDEX "StudentProfile_inviteToken_idx" ON "StudentProfile"("inviteToken");
...
-- AddForeignKey
ALTER TABLE "StudentProfile" ADD CONSTRAINT "StudentProfile_creatorTeacherId_fkey" FOREIGN KEY ("creatorTeacherId") REFERENCES "TeacherProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
